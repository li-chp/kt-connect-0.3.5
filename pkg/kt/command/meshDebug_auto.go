...
func NewAMeshDebugCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "adebug",
		Short: "Combines connect and amesh together",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return AMeshDebug(args[0])
		},
		Example: "et adebug <service-name> [command options]",
	}
